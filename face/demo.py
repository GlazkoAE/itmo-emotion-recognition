...
if __name__ == "__main__":
    ...
    face_bboxer = cv2.dnn.readNetFromCaffe(
        "./pretrained/deploy.prototxt",
        "./pretrained/res10_300x300_ssd_iter_140000.caffemodel",
    )
    emotion_classifier = torch.jit.load("./pretrained/ResnetRUL_cuda.pth")
    ...
    while True:
        ...
        cv2.imshow(
            "Faceial emotion detection demo",
            cv2.flip(cv2.cvtColor(image, cv2.COLOR_RGB2BGR), 1),
        )
